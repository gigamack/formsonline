<?php
class RequestDebtInvestigate extends CI_Controller
{
    private $data;
    private $DocumentID;
    ...
    public function Index()
    {
        ...
        $this->load->view('student/RequestDebtInvestigate');
    ...
    public function Edit($DocumentID)
    {
        ...
        $this->load->view('dashboard/header', $this->data);
        $this->load->view('student/edit/RequestDebtInvestigate');
        $this->load->view('dashboard/footer');
    }
    public function Get()
    { }
    ...
    private function sendMail()
    {
        ...
        $to_email = "iesorn.c@phuket.psu.ac.th";

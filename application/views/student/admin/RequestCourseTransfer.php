                                        ...
                                        <div class='row'>
                                            <div class='col-md'>
                                                <div class='form-row'>
                                                    ...
                                                    <div class='col-md-8'>
                                                        <input type="text" class='form-control' name="MobileNumber" id='MobileNumber' placeholder='Mobile Number' value="<?php echo $Document[0]->tel ?>" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class='col-md'>
                                    ...
                                    <div class='card-body'>
                                            ...
                                            <div class='form-check' id='divAdmissionToUniversity' style="display:none">
                                                <div class='row'>
                                                    <div class='col-md-2'>
                                                        ...
                                                        <input type="text" value="<?php echo ($TransferSubject[0]->ReasonForID == '1' ? $TransferSubject[0]->ReasonFor1 : '') ?>" class="form-control" name="txtAdmissionToUniversity" id="txtAdmissionToUniversity" placeholder="semester/year" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class='form-check' id='divFieldStudy' style="display:none">
                                                <div class='row'>
                                                    <div class='col-md'>
                                                        ...
                                                        <input type="text" value="<?php echo ($TransferSubject[0]->ReasonForID == '2' ? $TransferSubject[0]->ReasonFor1 : '') ?>" class="form-control" name="txtApproveMoveFromFieldStudyFrom" id="txtApproveMoveFromFieldStudyFrom" placeholder="from the field of study" readonly>
                                                    </div>
                                                ...
                                                <div class='row'>
                                                    <div class='col-md'>
                                                        ...
                                                        <input type="text" value="<?php echo ($TransferSubject[0]->ReasonForID == '2' ? $TransferSubject[0]->ReasonFor2 : '') ?>" class="form-control" name="txtApproveMoveFromFieldStudyTo" id="txtApproveMoveFromFieldStudyTo" placeholder="to the field of study" readonly>
                                                    </div>
                                                </div>
                                                <div class='row'>
                                                    <div class='col-md-2'>
                                                        <label for="">From Semester / Year : </label>
                                                        <input type="text" value="<?php echo ($TransferSubject[0]->ReasonForID == '2' ? $TransferSubject[0]->ReasonFor2 : '') ?>" class="form-control" name="txtApproveMoveFromFieldStudyYear" id="txtApproveMoveFromFieldStudyYear" placeholder="from semester/year" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class='form-check' id='divMoveFaculty' style="display:none">
                                                <div class='row'>
                                                    <div class='col-md'>
                                                        ...
                                                        <input type="text" value="<?php echo ($TransferSubject[0]->ReasonForID == '3' ? $TransferSubject[0]->ReasonFor1 : '') ?>" class="form-control" name="txtApproveMoveFromFacultyFrom" id="txtApproveMoveFromFacultyFrom" placeholder="from the faculty / college" readonly>
                                                    </div>
                                                ...
                                                <div class='row'>
                                                    <div class='col-md'>
                                                        ...
                                                        <input type="text" value="<?php echo ($TransferSubject[0]->ReasonForID == '3' ? $TransferSubject[0]->ReasonFor2 : '') ?>" class="form-control" name="txtApproveMoveFromFacultyTo" id="txtApproveMoveFromFacultyTo" placeholder="to the faculty / college" readonly>
                                                    </div>
                                                </div>
                                                <div class='row'>
                                                    <div class='col-md-2'>
                                                        <label for="">From Semester / Year</label>
                                                        <input type="text" value="<?php echo ($TransferSubject[0]->ReasonForID == '3' ? $TransferSubject[0]->ReasonFor3 : '') ?>" class="form-control" name="txtApproveMoveFromFacultyYear" id="txtApproveMoveFromFacultyYear" placeholder="from semester/year" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class='form-check' id='divMoveUniversity' style="display:none">
                                                <div class='row'>
                                                    <div class='col-md'>
                                                        ...
                                                        <input type="text" value="<?php echo ($TransferSubject[0]->ReasonForID == '4' ? $TransferSubject[0]->ReasonFor1 : '') ?>" class="form-control" name="txtApproveMoveFromUniversityFrom" id="txtApproveMoveFromUniversityFrom" placeholder="from the university" readonly>
                                                    </div>
                                                ...
                                                <div class='row'>
                                                    <div class='col-md'>
                                                        ...
                                                        <input type="text" value="<?php echo ($TransferSubject[0]->ReasonForID == '4' ? $TransferSubject[0]->ReasonFor2 : '') ?>" class="form-control" readonly name="txtApproveMoveFromUniversityTo" id="txtApproveMoveFromUniversityTo" placeholder="to the university" value='มหาวิทยาลัยสงขลานครินทร์' readonly>
                                                    </div>
                                                </div>
                                                <div class='row'>
                                                    <div class='col-md-2'>
                                                        <label for="">From Semester / Year : </label>
                                                        <input type="text" value="<?php echo ($TransferSubject[0]->ReasonForID == '4' ? $TransferSubject[0]->ReasonFor3 : '') ?>" class="form-control" name="txtApproveMoveFromUniversityYear" id="txtApproveMoveFromUniversityYear" placeholder="from semester/year" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class='form-group'>
                                            ...
                                            <div class='form-check' id='divOther' style="display:none">
                                                <div class='row'>
                                                    <div class='col-md'>
                                                        <input type="text" value="<?php echo ($TransferSubject[0]->ReasonForID == '5' ? $TransferSubject[0]->ReasonFor1 : '') ?>" class="form-control" name="txtOther" id="txtOther" id="txtOther" placeholder="Other" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="row">
                            <div class="col-md">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form method="post" action="<?php echo base_url("form/admin/requestcoursetransfer/approve/" . $Document[0]->DocumentID); ?>">
                                            <div class="row">
                                                <div class="col-md">
                                                    <textarea class="form-control col-md-6 mx-auto" placeholder="Your comment..." name="commentText" id="commentText" cols="30" rows="10"></textarea>
                                                </div>
                                            </div>
                                            <div class='row'>
                                                <div class='mx-auto'>
                                                    <button name='btnApprove' value="S02" id='btnApprove' class='btn btn-success'>Approve</button>
                                                    <button name='btnApprove' value="S03" id='btnDisapprove' class='btn btn-danger'>Disapprove</button>

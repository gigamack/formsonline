...
<div class="container">
	<div class="row">
		<div class="col-md">
			<form id="tempCardform" style="margin: 20px auto auto auto" action="<?php echo base_url("form/requesttemporarystudentcard/update/" . $Document[0]->DocumentID); ?>" method="post" enctype="multipart/form-data">
				<div class="card">
					...
					<div class="card-body">
						...
						<div class="row">
							<div class="col">
								<select class="custom-select" id="reason" name="reason" onchange="if (this.value=='5'){this.form['other'].style.display='block'}else {this.form['other'].style.display='none'};">
						...
						<div class="row">
							<div class="col">
								<input type="text" class="form-control" id="other" name="other" placeholder="ระบุ /Other" style="display:none;" />
							</div>
						</div>
						<div class="row">
							<div class="col">
						...
						<div class="row">
							<div class="col-md">
								<?php if (!empty($Document[0]->PoliceNoticePath)) { ?>
									<input type="hidden" name="oldfilename" value="<?php echo $Document[0]->PoliceNoticePath ?>" />
									<a class="btn btn-link btn-lg" target="_blank" href="<?php echo base_url("uploads/" . $Document[0]->PoliceNoticePath) ?>" role="button"><b>1. Attached File : </b><?php echo "The notice from police station." ?></a>
								<?php } ?>
							</div>
						</div>
						<div class="row">
...
<script>
	...
	$(document).ready(function() {
		...
		$("#reason").val(<?php echo $Document[0]->ReasonID ?>);
	});
</script>